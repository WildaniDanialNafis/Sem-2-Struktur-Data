 ...
 * @author WILDANII
 */
public class BinaryTreeTgs {
    Node root;
    int size;

    public BinaryTreeTgs() {
        root = null;
    }
    ...
    public int jumlahLeaf(Node current) {
        ...
        if (current.left != null) {
            countLeft = jumlahLeaf(current.left);
        }
        if (current.right != null) {
            countRight = jumlahLeaf(current.right);
        }
